...
function UpdateOrders() {
    ...
    const handelSubmit = async (e) => {
        ...
        try{
            const orders = await axios.put(`https://61b6012ac95dd70017d40dcd.mockapi.io/api/V1/Pizza/${localStorage.getItem("id")}`, updateOrders)
            console.log(orders)
            setIsSubmit(true)
        }catch(err) {
            console.log(err)
                    ...
                    <div className='row g-0'>
                        <div className='col-lg-5'>
                            ...
                            <div className='col-lg-7 px-5 pt-5'>
                                <h2 className='font-weight-bold py-3'>Update Pizza Details</h2>
                                <form className='' onSubmit={handelSubmit}>
                                    ...
                                    <div className='form-row'>
                                        <div className='col-lg-7'>
                                            <button type='submit' className='btn1 mt-3 mb-5 '> Update Item</button>
                                            {isSubmit &&
                                                <div>
                                                    <p className='successTXT'>ITEM Updated Successfully</p>
